---
title: Tiers and Charms
description: Free, Premium, and Premium Plus plans, and how the Charm wallet works.
tags:
  - tiers
  - billing
  - charms
...
- [Plan comparison](./comparison.md) - what each tier unlocks, side by side.
- [Chat limits](./chat-limits.md) - the two limits that can stop a Free chat, and what to do about each.
- [Charms](./charms.md) - what they buy, how to top up, where to see your balance.
- [Referrals](./referrals.md) - your invite link, and the Charms and discounts it can earn.
- [Upgrading and downgrading](./upgrading.md) - changing plan, managing billing, cancelling.
...
You pay by card on a separate checkout page. Card details are never
typed inside MISTRIX.

Open **Account > Plan > Subscription** to change your card, look at past
invoices, or cancel. See [Upgrading and downgrading](./upgrading.md).
